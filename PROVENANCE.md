...
| Version (current release) | v1.1.1 |
...
**(a) Cite the version.** The dataset evolves. Citing "the dataset" without a version number is ambiguous. Cite the version (`v1.1.1`) and, ideally, the manifest root hash. Both are in `MANIFEST.json` and `CITATION.cff`.
...
v1.1.1 root_hash: 5d117bbef8f01a0d3287c9a7a96a53098d58984beaad4be3616398599c8a9030   (data/tools/qa/build_manifest.py)
```
