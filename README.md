...
[![Version](https://img.shields.io/badge/version-1.1.0-blue.svg)](https://github.com/SpartanAltsoba/child-welfare-decision-chains/releases/tag/v1.1.0)
...
**v1.1.0 release:** 2,142 decision nodes · 51 jurisdictions · 2,634 files · SHA-256 verified

---

## Cite This Dataset

> Project Milk Carton (2026). *US Child Welfare Decision Chain Dataset* (Version 1.1.0). https://github.com/SpartanAltsoba/child-welfare-decision-chains
...
The current release is **v1.1.0** (see [CHANGELOG.md](./CHANGELOG.md)).
